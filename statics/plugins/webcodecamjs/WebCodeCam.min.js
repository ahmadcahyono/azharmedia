...
*/
;
(function(n,C,H,I){function D(b,a){this.element=b;t=n(b);this.options=n.extend({},E,a);this._defaults=E;this._name="WebCodeCam";this.init()&&(this.setEventListeners(),(this.options.ReadQRCode||this.options.ReadBarecode)&&this.setCallback())}var a,u,k,t,h,g,l={},e=n('<video style="position:absolute;visibility:hidden;display: none;">')[0],v=!1,F=!1,G=new Worker("js/DecoderWorker.js"),m=!1,E={ReadQRCode:!0,ReadBarecode:!0,width:200,height:200,videoSource:{id:!0,maxWidth:640,maxHeight:480},flipVertical:!1,
